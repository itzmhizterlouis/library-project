...
public class LibraryController {
    ...
    @Operation(summary = "(DELETE) Return Book", description = "Removes all the books requested by user")
    @PostMapping("books/requests/{bookRequestId}/return")
    public GenericResponse returnBook(@PathVariable int bookRequestId) {
